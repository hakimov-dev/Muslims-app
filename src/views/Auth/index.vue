<template>
  <div
    class="login form-wrap flex flex-col items-center text-center bg-[#131416] md:pt-[12%] pt-[55%] px-[8%] md:px-[3%] h-screen w-full md:w-[30%]"
  >
    <router-link
      to="/"
    ...
    <transition>
      <h1
        class="text-red-600 text-[16px] mt-[3%]"
        v-if="$store.state.auth.isError"
      >
        The login or password is incorrect. Please check and try again!
      </h1>
    </transition>
    <button
