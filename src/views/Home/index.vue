<template>
  <div class="main-page">
    <div class="alert alert-warning shadow-lg w-[93%] mx-auto top-0">
      <div>
        <svg
        ...
        <span
          >Warning: This page is progressing this page have some problems by API
          servers... Sorry for quorted problems.</span
        >
      </div>
    </div>
    <div
    ...
    >
      <Card
        v-for="item in $store.state.home.surahList"
